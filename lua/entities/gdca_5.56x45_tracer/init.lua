...
self.Penetrate 		= 5					// How deep Generic Default goes (in yo mama)
...
self.EffectSize		= 0.8					// How much stuff gets kicked up on impact
self.BlastDamage	= 40					// How much it dislodges your small intestine
...
Tracer:SetKeyValue("startwidth","15")
Tracer:SetKeyValue("endwidth","10")
...
function ENT:Think()
	...
	// THIS IS BULLET RICOCHET	
		...
		if (Dot*math.Rand(0.04,1)*mats[tr.MatType][1])>-0.04 then		// If it doesnt hit head on,
			...
			local attack =  gdc.caphit( tr.Entity, 50) 	// Entity, Damage
			end
			///
