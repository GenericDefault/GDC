...
self.Penetrate 		= 8					// How deep Generic Default goes (in yo mama)
...
self.EffectSize		= 1.35					// How much stuff gets kicked up on impact
self.BlastDamage	= 70					// How much it dislodges your small intestine
self.BlastRadius	= 90					// How big impact radius is
...
Tracer:SetKeyValue("startwidth","35")
...
function ENT:Think()
	...
	// THIS IS BULLET RICOCHET	
		...
		if (Dot*math.Rand(0.04,1)*mats[tr.MatType][1])>-0.04 then		// If it doesnt hit head on,
			...
			local attack =  gdc.caphit( tr.Entity, 120) 	// Entity, Damage
			end
			///
