...
self.Penetrate 		= 15					// How deep Generic Default goes (in yo mama)
...
self.EffectSize		= 1.8					// How much stuff gets kicked up on impact
self.BlastDamage	= 70					// How much it dislodges your small intestine
self.BlastRadius	= 150					// How big impact radius is
self.Drift		= 0.4					// How much the bullet will drift in flight (Inaccuracy)
