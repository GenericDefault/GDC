...
function ENT:Think()
	...
	local tr = util.TraceLine( trace )
			...
			return true
				...
				if tr.Hit then
					util.BlastDamage(self.Entity, self.Entity, tr.HitPos, 140, 70)
					local effectdata = EffectData()
					effectdata:SetOrigin(tr.HitPos)
					effectdata:SetScale(1.75)
					...
					local attack =  gcombat.hcghit( tr.Entity, 200, 20, tr.HitPos, tr.HitPos) 	// Entity, Damage, Pierce
					end
