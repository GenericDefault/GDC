...
self.Penetrate 		= 10					// How deep Generic Default goes (in yo mama)
self.Flightvector 	= self.Entity:GetUp()*590		// Velocity in inches/sec
...
self.BlastRadius	= 100					// How big impact radius is
...
function ENT:Think()
	...
	// THIS IS BULLET RICOCHET	
		...
		if (Dot*math.Rand(0.04,1)*mats[tr.MatType][1])>-0.04 then		// If it doesnt hit head on,
			...
			local attack =  gdc.caphit( tr.Entity, 145) 	// Entity, Damage
			end
			///
